...
class Standard(AdvTrainer):
    ...
    def calculate_cost(self, train_data, reduction='mean'):
        ...
        # print("!!!! TEMPORAL USE OF RandomCutMixV2")
        # import kornia
        # aug = kornia.augmentation.RandomCutMixV2()
        # aug =  kornia.augmentation.auto.AutoAugment(policy='cifar10')
        # images = aug(images, labels)
        # images = results[0]
        # labels = results[1]
